...
class UserService {
    async updateById(id, name, github, linkedin, twitter, instagram) {
        if (!name) {
        ...
        const user_updated = await userRepository.updateById(id, updateData)
        ...
        const auth_token = jwt.sign(
            {
                ...
                id: user_updated._id,
                github: user_updated.github,
                linkedin: user_updated.linkedin,
                twitter: user_updated.twitter,
                instagram: user_updated.instagram,
            },
